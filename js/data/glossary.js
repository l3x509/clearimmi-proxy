  ...
  status: [
    {
      ...
      volatile: true,
      volatilityNote: {
        en: "TPS status has been especially unstable in 2026, with ongoing lawsuits over several countries' designations — including Haiti, where status has changed multiple times through the courts in the past year, most recently terminated effective July 27, 2026 following a Supreme Court ruling. If TPS affects you, don't rely on this page for your specific dates or deadlines — check uscis.gov/tps directly and talk to an accredited representative, because the situation can change within days.",
        ht: "Estati TPS te espesyalman enstab an 2026, ak pwosè k ap kontinye sou deziyasyon plizyè peyi — enkli Ayiti, kote estati a chanje plizyè fwa nan tribinal yo ane pase a, dènyèman fini efikas 27 Jiyè 2026 apre yon desizyon Tribinal Siprèm. Si TPS afekte ou, pa depann sou paj sa a pou dat oswa delè espesifik ou — tcheke uscis.gov/tps dirèkteman epi pale ak yon reprezantan akredite, paske sitiyasyon an ka chanje nan kèk jou.",
        fr: "Le statut TPS a été particulièrement instable en 2026, avec des procès en cours sur les désignations de plusieurs pays — y compris Haïti, dont le statut a changé plusieurs fois devant les tribunaux l'année dernière, le plus récemment terminé le 27 juillet 2026 suite à une décision de la Cour suprême. Si le TPS vous concerne, ne vous fiez pas à cette page pour vos dates ou délais précis — vérifiez directement sur uscis.gov/tps et parlez à un représentant accrédité, car la situation peut changer en quelques jours."
      },
      simple: {
        en: [
